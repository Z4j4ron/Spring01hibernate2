...
public class BookController {
    ...
    void save(@RequestParam String title, @RequestParam int rating,
              @RequestParam String description, @RequestParam String publisherName,
              @RequestParam("authorId") Long[] authorIds) {
    ...
    @GetMapping(path = "/books1", produces = "text/plain;charset=utf-8", params = "rating")
